...
function App() {
  ...
  if (!data) {
    return <div className="w-[372px] bg-surface p-6 text-sm text-muted">Loading…</div>;
  }
  ...
  return (
    <div className="w-[372px] overflow-hidden bg-surface font-sans text-ink">
            ...
            >
              ...
              <div className="min-w-0 flex-1">
                <div className="flex items-baseline justify-between gap-2">
                  ...
                  <span className={`shrink-0 text-[13px] font-semibold tabular-nums ${blocked ? 'text-faint' : 'text-muted'}`}>
